...
let g:colors_name="maincolor"

highlight! Default guifg=#d6b48b guibg=#0F3A3A gui=NONE
" link to normal does not work here for some reason...
" highlight! Normal guifg=#edceab guibg=#042327 gui=NONE
highlight! Normal guifg=#d6b48b guibg=#0F3A3A gui=NONE
...
highlight! EndOfBuffer               guifg=#0F3A3A       guibg=#0F3A3A      gui=NONE
"0F3A3A
