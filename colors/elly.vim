...
let s:palette.bk01      = {"gui": {"dark": "#859099"}, "cterm": {"dark": "234"}}
let s:palette.bk02      = {"gui": {"dark": "#14191F"}, "cterm": {"dark": "234"}}
let s:palette.bk03      = {"gui": {"dark": "#778899"}, "cterm": {"dark": "234"}} " numbers
let s:palette.comment   = {"gui": {"dark": "#5A5A5A"}, "cterm": {"dark": "240"}}
let s:palette.error     = {"gui": {"dark": "#810002"}, "cterm": {"dark": "  1"}}
let s:palette.selection = {"gui": {"dark": "#638296"}, "cterm": {"dark": "235"}}
